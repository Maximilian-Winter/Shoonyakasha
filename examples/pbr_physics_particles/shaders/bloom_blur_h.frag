...
//
// 13-tap Gaussian blur along the horizontal axis.
// Operating at half resolution, this produces a wide, soft glow
// that shall be further refined by the vertical pass.
//
...
void main() {
    ...
    // Centre weight + 6 taps each side = 13 taps total
