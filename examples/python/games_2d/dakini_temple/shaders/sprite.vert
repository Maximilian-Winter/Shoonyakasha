#version 450
//
// Sprite/UI vertex shader, used here for the text labels.
//
...
void main() {
    ...
    if (push.screenSpace > 0.5) {
        // worldPos.xy is in pixel coordinates (top-left origin), and Vulkan
        // clip space is top-down like screen pixel space.
